...
export const SPORTS = [
  ...
  },
  {
    ...
    notes: ['Golf markets are outrights across a 150-player field. The two-competitor engine does not apply, so leaderboards are shown and no tip is written.'],
  },
  {
    key: 'gaelic-football',
  ...
  },
  {
    ...
    candidateLeagues: [],
    notes: ['No key-less PDC results/averages feed. Market rows only.'],
  },
  {
    key: 'snooker',
    name: 'Snooker',
    ...
    candidateLeagues: [],
    notes: ['No key-less WST results feed. Market rows only.'],
  },
  {
    key: 'horse-racing',
    name: 'Horse Racing',
  ...
  },
  {
    ...
    officialLinks: [
      ...
      { label: 'GBGB Results', url: 'https://www.gbgb.org.uk/greyhound-racing/results/' },
    ],
    candidateLeagues: [],
