...
export const SPORTS = [
  ...
  },
  {
    ...
    officialLinks: [
      { label: 'VNL schedule & results', url: 'https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/schedule/' },
      { label: "VNL women's standings", url: 'https://en.volleyballworld.com/volleyball/competitions/volleyball-nations-league/standings/women/' },
    ...
    notes: [
      'The specialist model is limited to FIVB Volleyball Nations League — Women. NCAA, EuroVolley, club and generic volleyball listings cannot enter its form or prediction score.',
      'The separately rendered OLBG market monitor records only event-page market headings it verified. OLBG votes are display-only, never a price source.',
      'A MATCH WINNER selection needs an agreeing moneyline from two named bookmakers; incomplete evidence is an explicit SKIP.',
    ],
  },
  {
    key: 'mma',
