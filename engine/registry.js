...
export const SPORTS = [
  ...
  },
  {
    ...
    predictable: true,
    unit: 'points',
    specialistEngine: 'gaa',
    page: 'gaa.html',
    subPages: [
      { key: 'gaelic-football', label: 'Football', href: 'gaa.html?code=football', name: 'Gaelic football' },
      { key: 'hurling', label: 'Hurling', href: 'gaa.html?code=hurling', name: 'Hurling' },
    ],
    officialLinks: [
      { label: 'OLBG Gaelic Football Tips', url: olbgUrl('Gaelic_Football', 25) },
      { label: 'OLBG Hurling Tips', url: 'https://www.olbg.com/betting-tips/Hurling/26' },
      { label: 'GAA Official Fixtures', url: 'https://www.gaa.ie/fixtures-results' },
      { label: '2026 All-Ireland Senior Football Championship', url: 'https://en.wikipedia.org/wiki/2026_All-Ireland_Senior_Football_Championship' },
    ],
    candidateLeagues: [
      { slug: 'all-ireland-sfc', name: 'All-Ireland Senior Football Championship' },
      { slug: 'county-football', name: 'County football championships' },
      { slug: 'all-ireland-shc', name: 'All-Ireland Senior Hurling Championship' },
      { slug: 'county-hurling', name: 'County hurling championships' },
    ],
    notes: [
      'Gaelic games run on their own specialist page, scored by the GAA PREDICTION MASTER PROMPT v1.1. Football and hurling share the engine with a code filter. The OLBG football (id 25) and hurling (id 26) indexes supply the live club-championship slate; they publish tipster votes, never prices.',
      'No key-less GAA price feed exists, so the 30-pt odds factor is recorded as the prompt\'s 10-pt missing-odds substitute and Step 3 live bets resolve to SKIP. Club championship form has no free structured tape, so those matches carry a data-gap note and confidence is capped at MEDIUM.',
      'Inter-county results on the calendar are only matches whose scoreline is printed on the Wikipedia championship pages. Ulster and Tailteann 2026 winners are listed as pedigree, not as invented scorelines.',
    ],
  },
  {
    key: 'darts',
