...
| Create a GitHub Page for the repo | **PARTIAL / DEPLOYMENT READY** | Pages site already exists; workflow files are present on the feature branch for Actions deployment | Remaining step is repository Pages configuration: the public site is still in legacy branch-deploy mode until switched to GitHub Actions | `index.html`, `.github/workflows/pages.yml`, `README.md`, `docs/IRREGULARITIES.md` |
